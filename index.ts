...
console.log("El resulado de la suma es: ", calculadora.suma(3,4));
console.log("El resulado de la resta es: ", calculadora.resta(3,4));

//funciones asincronas. 
// consumo de APIS, son llamadas a funciones asincronas, nuestro codigo forzosamente debe de esperar a esta funcion para empezar a codificar las reglas de negocio
//se instala libreria node.fech, mpm install node-fetch, npm i --save-dev @types/node
/*
{
...
//MODULOS en typescript 
{
    ...
    let clienteObject: ClienteObjectInterface ={
        nombre: 'Jessica',
        direccion: 'Av. del Trabajo',
        creado: new Date()
    }
...
//SERVERLESS: funciones que se venden como servicio 
// tipificacion de datos 
//servicio proporcionado por un proveedor donde se facilita un servidor
//Infraestructura que nos provee un proveedor externo (AWS, AZURE) 
...
//EJERCICIO 2
...

    {
        class User implements IUser {
            ...
            {
                function CorridasW(descripcionServicio, empresa = "AEF") { 
                var cw = [];
                var a = [];
                corridasWeb.forEach (corridaW =>{
                    if(corridaW.empresa == empresa && corridaW.descripcionServicio == descripcionServicio){
                        a = {
                            "numeroCorrida" : corridaW.numeroCorrida,
                            "descripcionServico" : corridaW.numeroCorrida,
                            "empresa" : empresa,
                            "descripcionEmpresa" : corridaW.descripcionEmpresa,
                        };
                        cw.push(a);
                    }
                });
